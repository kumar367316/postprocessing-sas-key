...
public class PostProcessingConstant {
	...
	public static final String ACCOUNT_KEY_VALUE = "DefaultEndpointsProtocol=https;AccountName=pmapostprcoessing1;AccountKey=LR+HG362j6Iym94zQyPydi5+PpqNgRmRtwRC8B2XnXfhk7ggA9a7R1FN0vIcrInFssQN3OAhEpDC+AStu3b5mQ==;EndpointSuffix=core.windows.net";
